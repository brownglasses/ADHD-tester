...
- **텍스트**: "📄 PDF로 저장하기"
- **스타일**: Accent 색상, Large 크기
- **기능**: `handleDownloadPDF()`
  - 모든 검사 결과를 PDF로 생성
  - 자동 다운로드
...
1. **PDF 저장**
   ...
   - "위의 'PDF로 저장하기' 버튼을 눌러 결과를 저장하세요"

2. **병원 검색**

   - "'병원 찾기'에서 근처 정신건강의학과를 검색하세요"

3. **예약 안내**

   - "병원 예약 시 '성인 ADHD 진단 상담'이라고 말씀하세요"

4. **진료 준비**
   - "진료 시 저장한 PDF 결과를 가져가시면 도움이 됩니다"
